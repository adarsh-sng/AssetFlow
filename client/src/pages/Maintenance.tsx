...
import { fetchMaintenanceTickets } from '../lib/services'
...
export function MaintenancePage() {
  ...
  const { data: tickets = [], isLoading } = useQuery({
    ...
    queryFn: () => fetchMaintenanceTickets(search),
  })
  ...
  return (
    <div className="space-y-6">
      ...
      {isLoading ? (
        <p className="text-sm text-foreground/50">Loading maintenance tickets...</p>
      ) : (

      ...
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <h1 className="font-serif text-4xl font-light text-foreground">
            AssetFlow <span className="text-foreground/40">— sign up</span>
          </h1>
        </div>
        ...
        <div className="space-y-4">
          ...
          <Link
            to="/login"
            className="block w-full border border-border-subtle bg-white px-4 py-3 text-sm font-medium text-foreground text-center hover:shadow-custom transition-shadow"
          >
            Sign In
          </Link>
        </div>
